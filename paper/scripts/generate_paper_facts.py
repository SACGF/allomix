...
def main():
    ...
    # Figures are generated by scripts/run_depth_validation.py and copied to
    # output/facts/ automatically.  Run that script before vibepaper build.

    print("\nDone! Facts written to output/facts/")
    print("Run scripts/run_depth_validation.py to regenerate figures.")
